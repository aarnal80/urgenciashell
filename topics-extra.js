 ...
 "intoxicacion_por_anticoagulantes_orales_dicumarinicos_avk": {
   ...
   },
   {
    ...
    "items": [
     ...
     },
     {
      ...
      "clave": "Se recomienda investigar siempre una causa orgánica subyacente",
      "slug": null
     }
    ]
   }
  ...
  "plan": [
   ...
   },
   {
    ...
    "detalle": "INR 4,5-10: suspende Sintrom sin vitamina K de rutina. INR >10: vitamina K1 1-5 mg oral; también puede utilizarse 2 mg oral y nuevo INR a las 24 h. [contradicción entre fuentes: seguir protocolo local]."
   },
   {
    "paso": "Maneja el sangrado leve o moderado",
    "detalle": "Con INR >5, suspende el AVK 1-2 días hasta detener el sangrado y valora vitamina K oral 2-5 mg según INR y riesgo tromboembólico. Aplica medidas locales y recontrola el INR según protocolo local."
   },
   {
    "paso": "Revierte la hemorragia significativa en el hospital",
    "detalle": "Vitamina K1 5-10 mg IV muy lentamente, sin superar 1 mg/minuto. También puede contemplarse 10 mg oral o parenteral diluidos en 100 ml de suero fisiológico en 10-20 min. [contradicción entre fuentes: la vía y la dosis deben ajustarse al protocolo hospitalario vigente].",
    "sub": [
     {
      "nivel": "critico",
   ...
   },
   {
    ...
    "detalle": "Prothromplex Total: 25 UI/kg con INR 2,0-3,9; 35 UI/kg con INR 4,0-6,0; 50 UI/kg con INR >6,0. La dosis máxima necesaria para corregir el INR es 50 UI/kg; exige supervisión experta por el riesgo tromboembólico."
   },
   {
    "paso": "Planifica el control y el reinicio",
    "detalle": "Repite INR a las 24 h si era >10 sin sangrado y a los 7-10 días en sangrado leve/moderado según protocolo local. Reinicia Sintrom cuando el INR esté en rango objetivo y el equipo responsable haya reevaluado el riesgo tromboembólico."
   }
  ],
  "biblio": [
   "Servicio Navarro de Salud. Guía de actuación anticoagulación oral v1.2. Revisión 26-02-2025, pp. 33-35 y tabla 11 en p. 34.",
