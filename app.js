...
(function () {
  ...
  function renderTopic(slug) {
    ...
    if ((t.tabla_tiempos || []).length) {
      html += block("timing", "Tiempo desde la ingesta · orientación diagnóstica", false,
        '<div class="table-wrap"><table class="timing-table"><thead><tr><th>Inicio</th><th>Patrón</th><th>Etiología orientativa</th><th>Clave</th></tr></thead><tbody>' +
        t.tabla_tiempos.map(function (x) {
          return '<tr><td data-label="Inicio">' + esc(x.inicio || "") + '</td><td data-label="Patrón">' + esc(x.patron || "") + '</td><td data-label="Etiología">' + esc(x.etiologia || "") + '</td><td data-label="Clave">' + esc(x.clave || "") + '</td></tr>';
